      ...
      <>
        ...
        <div className={`absolute border-opacity-90 border h-full mb-8 ${darkMode ? 'border-cyan-500' : 'border-cyan-800'}`} style={{left: 'calc(50% - 2px)'}}></div>
          ...
          <div className="flex justify-center px-8 mt-4 -ml-2">
            <Card icon={faCode} goRightIcon firstItem title='Développeur' subtitle='Carrefour, Apprentissage en Alternance' duration='1 an' src='2022_bac_3.jpg' src2='2022_bac_3_duo.png'>Développement et maintenance d'applications internes, principalement en PHP, mais aussi en SQL et JS.<br />Environnement Windows et Linux, Git.<br />Équipe restreinte, méthode Agile.<br /><br />Utilisation quotidienne de Linux.<br />Git, dev, hors-prod et production en équipe.<br />Découverte de la gestion des VM en grande entreprise.</Card>
          </div>
      ...
      <>
        <div className="flex flex-col items-center justify-center overflow-hidden mb-8">
          <div className="relative mb-2">
            ...
            <Card icon={faCode} title='Développeur' subtitle='Carrefour, Apprentissage en Alternance' duration='1 an' src='2022_bac_3.jpg' src2='2022_bac_3_duo.png'>Développement et maintenance d'applications internes.<br />Principalement en PHP, mais aussi en SQL et JS.<br />Environnement Windows et Linux, Git.<br />Équipe restreinte, méthode Agile.<br /><br />Utilisation quotidienne de Linux.<br />Git, dev, hors-prod et production en équipe.<br />Découverte de la gestion des VM en grande entreprise.</Card>
            <Card icon={faLaptopCode} title='Développeur Web' subtitle='Formation continue chez 3w Academy' duration='3 mois' src='2020_bac_2.jpg'>Acquisition des bases du Développement Web et autoformation.<br />Création de site avec les langages HTML, CSS, JS, PHP et SQL.<br />Découverte de VSC, mySQL, Bootstrap, WordPress, jQuery, Git...<br /><br />Émerveillement du potentiel informatique.<br />Intérêt croissant envers le développement.<br />Naissance d'une passion.</Card>
